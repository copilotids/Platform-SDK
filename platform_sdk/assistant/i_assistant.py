...
class AssistantResponse:
    ...
    structured input and output used/generated
    ...
    """
    input_additional_info: Optional[dict]
    """
    Additional information used by the assistant to respond
    to the request.
    """
    output_additional_info: Optional[dict]
    """
...
class Assistant(ABC):
    ...
    async def invoke(
        ...
        :param additional_info: Additional information to be used when
